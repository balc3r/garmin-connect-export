...
def http_req(url, post=None, headers={}):
    ...
    Params:
        url: String.
        post: Dictionary of parameters for POST request.
    ...
    request.add_header('User-Agent', ('Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 '
                       '(KHTML, like Gecko) Chrome/54.0.2816.0 Safari/537.36'))
    ...
    for a in activities:
        ...
        #except urllib2.HTTPError as e:
            ...
            if '204' in str(e) and args.format == 'gpx':
                ...
                # Added code to handle this exception. Also ignores .gpx validation for these
                # activites since file is empty.
